...
function ModalCadastrar({ show, onHide, Cadastro }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setFormDoacao({ doa_doador_id: '', doa_valor: '', doa_data: '', doa_observacao: '' });
            setErros({});
            setMensagem({ tipo: 'success', texto: 'Doação cadastrada com sucesso!' });
            if (Cadastro) Cadastro();
        } catch (error) {
            setMensagem({ tipo: 'danger', texto: 'Erro ao salvar doação. Tente novamente.' });
        }
    };
