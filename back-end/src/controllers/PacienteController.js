...
class PacienteController {
    ...
    static async criar(req, res) {
        try {
            const { pa_cpf, pa_nome, pa_data_nascimento, pa_telefone, pa_endereco, pa_email } = req.body;
            ...
            const paciente = await PacienteModel.criar({ pa_cpf, pa_nome, pa_data_nascimento, pa_telefone, pa_endereco, pa_email });
    ...
    static async atualizar(req, res) {
        try {
            ...
            const paciente = await PacienteModel.atualizar(id, { pa_cpf, pa_nome, pa_data_nascimento, pa_telefone, pa_endereco, pa_email });
    ...
    static async relatorio(req, res) {
        try {
            ...
            const colunas = ["ID", "Nome", "CPF", "Telefone", "E-mail", "Endereço"];
